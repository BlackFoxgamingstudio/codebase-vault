#!/usr/bin/env python3
"""
Standalone Microservice Webhook Adapter for sovereign-codebase-vault
Listens on port 8766 and translates n8n requests into deterministic engine executions.
"""
import sys
import os
import json
...
def run():
    server = HTTPServer(("0.0.0.0", 8766), WebhookHandler)
    print(f"[Sovereign Codebase Vault] Webhook Adapter listening on http://0.0.0.0:8766")
